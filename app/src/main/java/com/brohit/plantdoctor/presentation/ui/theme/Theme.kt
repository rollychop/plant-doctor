package com.brohit.plantdoctor.presentation.ui.theme
...
private val LightColorPalette = PlantDoctorColors(
    brand = Shadow5,
...
private val DarkColorPalette = PlantDoctorColors(
    brand = Shadow1,
...
fun PlantDoctorTheme(
    ...
    ProvidePlantDoctorColors(colors) {
        MaterialTheme(
...
object PlantDoctorTheme {
    val colors: PlantDoctorColors
        @Composable
...
class PlantDoctorColors(
    ...
    fun update(other: PlantDoctorColors) {
    ...
    fun copy(): PlantDoctorColors = PlantDoctorColors(
...
@Composable
fun ProvidePlantDoctorColors(
    colors: PlantDoctorColors,
    content: @Composable () -> Unit
) {
    ...
    CompositionLocalProvider(LocalPlantDoctorColors provides colorPalette, content = content)
}
 ...
 * [MaterialTheme.colors] in preference to [PlantDoctorTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
